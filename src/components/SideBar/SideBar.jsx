    ...
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <Link
            to="/"
            className="md:block md:pb-2 mr-0 inline-block p-4 px-0 w-[10rem] lg:w-[12rem] ml-0"
          >
          ...
          >
            ...
            {/* Heading */}
            <h6 className="md:min-w-full text-black text-xs uppercase font-bold block pt-1 pb-4 no-underline">
              app Layout Pages
            </h6>
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="items-center">
                <Link
                  className="text-black hover:text-black text-xs uppercase py-3 font-bold block"
                  to="/auth/login"
                >
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/auth/register"
                >
                  <i className="fas fa-clipboard-list text-black mr-2 text-sm"></i>{" "}
                  Register
                </Link>
              </li>
            </ul>
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="items-center">
                <Link
                  ...
                  to="/landing"
                >
                  <i className="fas fa-newspaper text-black mr-2 text-sm"></i>{" "}
                  Landing Page
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/profile"
                >
                  <i className="fas fa-user-circle text-black mr-2 text-sm"></i>{" "}
                  Profile Page
                </Link>
              </li>
            </ul>
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="inline-flex">
                ...
                >
                  <i className="fas fa-paint-brush mr-2 text-black text-base"></i>
                  Styles
                </a>
              </li>
              ...
              <li className="inline-flex">
                <a
                  ...
                  className="text-black hover:text-black text-sm block mb-4 no-underline font-semibold"
                >
                  <i className="fab fa-css3-alt mr-2 text-black text-base"></i>
                  CSS Components
                </a>
              </li>
              ...
              <li className="inline-flex">
                <a
                  ...
                  className="text-black hover:text-black text-sm block mb-4 no-underline font-semibold"
                >
                  <i className="fab fa-angular mr-2 text-black text-base"></i>
                  Angular
                </a>
              </li>
            </ul>
