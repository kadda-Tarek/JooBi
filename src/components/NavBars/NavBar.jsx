...
export default function Navbar() {
  return (
    <nav className="top-0 left-0 w-full z-10 bg-sky-600 md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
      <div className="w-full mx-auto flex items-center justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
        {/* Brand */}
        <button className="text-white text-sm uppercase hidden lg:inline-block font-semibold">
          Dashboard
        </button>
